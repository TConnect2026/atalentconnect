...
export function PanelistCandidateView({
  ...
  return (
    <div className="space-y-6">
      {/* Candidate Info Card */}
      <div className="bg-bg-section rounded-xl p-6">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            {candidate.stage_name && (
              <span className="inline-block mt-2 text-xs px-2 py-1 rounded bg-navy/10 text-navy font-medium">
                {candidate.stage_name}
              </span>
            )}
        ...
        {/* Links */}
        <div className="flex items-center gap-4 mt-4 pt-4 border-t border-ds-border">
          ...
          {interviewGuideUrl && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-1.5 text-sm font-medium text-text-secondary hover:underline"
            >
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
