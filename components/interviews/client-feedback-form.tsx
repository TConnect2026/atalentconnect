    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[600px] bg-white max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-5 mt-4">
          ...
          {/* Interview Notes */}
          <div>
            <Label htmlFor="interviewNotes" className="text-gray-700 font-semibold">
          ...
          {/* Strengths */}
          <div>
            <Label htmlFor="strengths" className="text-gray-700 font-semibold">
              Key Strengths
            </Label>
            <Textarea
              id="strengths"
          ...
          {/* Concerns */}
          <div>
            <Label htmlFor="concerns" className="text-gray-700 font-semibold">
              Concerns or Gaps
            </Label>
            <Textarea
              id="concerns"
